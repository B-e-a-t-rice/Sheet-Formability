...
negative_path = 'sample_2_augmented/'
...
positive_path1 = 'sample_6_augmented/'
images6 = []
labels6 = []
...
for f in os.listdir(positive_path1):
    ...
    labels6.append(1.0)
'''
positive_path2 = 'sample_6_second_500_images/second 500 sample 6 Intensity images/'
...
np.save("all_inputs_aug.npy", inputs)
np.save("all_targets_aug.npy", targets)
